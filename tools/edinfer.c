...
int main(int argc,char**argv){
    ...
    if(!mp||!ip){fprintf(stderr,"usage: edinfer --model M.edm --input IMAGE [--runtime host|fpga-model] [--threads N] [--score-threshold F] [--nms-threshold F] [--tiles-x auto|N --tiles-y N --tile-overlap F] [--power-limit W] [--core-watts W]\n");return 2;}
